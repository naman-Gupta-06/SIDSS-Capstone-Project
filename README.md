...
$Cost = \sum (Quantity_i \times UnitCost_i)$
...
```bash
git clone https://github.com/YOUR_USERNAME/SIDSS-Capstone-Project.git
...
Wait until you see the "Started SidssApplication" message. The server will run on:
```bash
http://localhost:8080
```
